...
<script>
	function divisionInfo(division, itemCode){
...
<section class = "py-5">
	<div class = "container px-4 px-lg-5 mt-5">
		<div class = "row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 jstify-content-center">
				...
				<div class = "col mb-5">
					<div class = "card h-100">
						...
						<div class = "card-body p-4">
							<div class = "text-center">
								...
								<div class = "d-flex justify-content-center small text-warning mb-2">
									<div class = "bi-star-fill">${vo.likeIt }</div>
								</div>
						...
						<div class = "card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class = "text-center">
								<a class = "btn btn-outline-dark mt-auto" onclick = "divisionInfo('${vo.division }', '${vo.itemCode }')">
									View options
								</a>
							</div>
						</div>
